  ...
  )
{
  ...
  //CpuMpData->FinishedCount = 299; // Count

  CpuMpData->CpuCount = CpuMpData->FinishedCount + 1;
  DEBUG ((DEBUG_INFO, "@528: CpuMpData->CpuCount = %d\n", CpuMpData->CpuCount )); // Count
  DEBUG ((DEBUG_INFO, "@529: PcdCpuMaxLogicalProcessorNumber  = %d\n", PcdGet32 (PcdCpuMaxLogicalProcessorNumber) )); // Count
  ...
  )
{
  ...
  if (MpHandOff == NULL) {
    ...
    DEBUG ((DEBUG_INFO, "@2018: MaxLogicalProcessorNumber = %d\n", MaxLogicalProcessorNumber)); // Count
  } else {
    MaxLogicalProcessorNumber = MpHandOff->CpuCount;
    DEBUG ((DEBUG_INFO, "@2020: MaxLogicalProcessorNumber = %d\n", MaxLogicalProcessorNumber)); // Count
  }
  //MaxLogicalProcessorNumber = 300;  //Count
  DEBUG ((DEBUG_INFO, "@2024: MaxLogicalProcessorNumber = %d\n", MaxLogicalProcessorNumber)); // Count
