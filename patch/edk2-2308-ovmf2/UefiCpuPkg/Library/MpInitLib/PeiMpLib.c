  ...
  )
{
  ...
  DEBUG ((DEBUG_INFO, "@145: MP_HAND_OFF = %d\n", sizeof(MP_HAND_OFF))); // Count
  DEBUG ((DEBUG_INFO, "@146: PROCESSOR_HAND_OFF = %d\n", sizeof(PROCESSOR_HAND_OFF))); // Count
  DEBUG ((DEBUG_INFO, "@147: MpHandOffSize = %d\n", MpHandOffSize)); // Count
  DEBUG ((DEBUG_INFO, "@148: EFI_HOB_GUID_TYPE = %d\n", sizeof(EFI_HOB_GUID_TYPE))); // Count
